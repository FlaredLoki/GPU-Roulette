...
- **[Pranav A]** — static analysis engine: C parser (`code_parser.py`), 17-feature extractor (`feature_extractor.py`), roofline positioning (`roofline.py`), fix-suggestion engine (`fixits.py`), CLI (`cli.py`)
